...
export const TvWatchVideo = () => {
    ...
    return (
        <>
            ...
            <section className='flex gap-x-10 p-6 bg-slate-900'>
                <div className='lg:w-2/3 space-y-3'>
                    <video controls className='w-full h-max'>
                        <source src={video1} type="video/mp4" />
                    </video>

                    <div className='xl:flex gap-10 items-end'>
                        <div className='xl:w-1/2 space-y-3 py-3'>
                        ...
                        <div className='xl:w-1/2 text-sm py-3'>
                            <div className='grid grid-cols-5 text-slate-300'>
                                ...
                                <div className='flex gap-2 cursor-pointer' onClick={() => showItem('share')} >
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div className='xl:flex gap-3 text-sm items-center'>
                    ...
                    <div className='flex justify-between items-center py-3'>
                        <div className="flex gap-4 items-start px-5">
                            ...
                            <div className='w-3/4'>
                                <input className='bg-transparent border-b border-slate-600 w-96 pb-2 ' placeholder='Add a comment'></input>
                            </div>
                        </div>
                    </div>
