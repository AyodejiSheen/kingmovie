...
export const ShortComments = () => {
    ...
    return (
        <>
            ...
            {/* <div className="absolute top-0 left-0" >
                <div className="inset-0 fixed bg-slate-800 w-screen z-50 h-[100vh] bg-opacity-70 flex items-center px-3">
                    <div data-aos="fade-down" data-aos-duration="600" data-aos-easing="ease-in-out" className="rounded-lg space-y-4 bg-white dark:bg-slate-700 mx-auto w-full lg:w-2/3 2xl:w-1/2 py-3">
                        ...
                        <div className='w-1/3 text-slate-700 border-2 border-slate-400 rounded-xl p-6 relative'>
                            <div className="flex justify-between items-center  2xl:px-8  border-b dark:border-slate-600 py-4  px-4 md:px-6">
                                <div>
                                    <h2 className="text-sm 2xl:text-xl font-bold dark:text-slate-400">Comments</h2>
                                </div>

                                <div>
                                    <button onClick={() => showItem('comments')} className="text-lg 2xl:text-2xl dark:text-slate-300"><i class="lni lni-close"></i></button>
                                </div>
                            </div>

                            <div className='space-y-6 pt-6 h-[35em] fixed overflow-y-scroll w-[22%]'>
                                <div className='flex items-end space-x-4'>
                                    <div className='space-y-1.5'>
                                        <div className='bg-slate-100 text-black rounded-tl-xl rounded-tr-xl rounded-br-xl p-5'>
                                            <p className='text-sm'>Hello! Welcome on zue world. Just drop
                                    ...
                                    <div className='flex items-end -space-x-3'>
                                        <img src={sub8} alt="imagghe" className='rounded-full w-28 md:w-24 -mt-24' />
                                    </div>
                                </div>
                                ...
                                <div className='flex items-end space-x-4'>
                                    ...
                                    <div className='flex items-end -space-x-3'>
                                        <img src={sub4} alt="imagghe" className='rounded-full w-28 md:w-24 -mt-24' />
                                    </div>
                                </div>
                                ...
                                <div className='flex items-end space-x-4'>
                                    ...
                                    <div className='flex items-end -space-x-3'>
                                        <img src={sub10} alt="imagghe" className='rounded-full w-28 md:w-24 -mt-24' />
                                    </div>
                                </div>
            ...
            <div className="absolute top-0 left-0" >
                <div className="inset-0 fixed bg-slate-800 w-screen z-50 h-[100vh] bg-opacity-70 flex items-center px-3">
                    <div data-aos="fade" data-aos-duration="600" data-aos-easing="ease-in-out" className="rounded-lg space-y-4 bg-white mx-auto w-[45rem] px-14">
                        <div className=' text-slate-700 rounded-xl p-6 relative bg-white h-[50rem]  '>
                            <div className="flex justify-between items-center  2xl:px-8  border-b dark:border-slate-600 py-4  px-4 md:px-6">
                                <div>
                                    <h2 className="text-sm 2xl:text-xl font-bold dark:text-slate-400">Comments</h2>
                                </div>
                                ...
                                <div>
                                    <button onClick={() => showItem('comments')} className="text-lg 2xl:text-2xl dark:text-slate-300"><i class="fa-sharp fa-solid fa-circle-xmark"></i></button>
                                </div>
                            </div>

                            <div className='space-y-6 pt-6 h-[40em] fixed overflow-y-scroll w-[35rem] mx-auto justify-center'>
                                <div className='flex items-end space-x-4'>
                                    <div className='space-y-1.5'>
                                        <div className='bg-slate-100 text-black rounded-tl-xl rounded-tr-xl rounded-br-xl p-5'>
                                            <p className='text-sm'>Hello! Welcome on zue world. Just drop
