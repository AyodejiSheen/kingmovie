        ...
        <>
            ...
            <div className="absolute top-0 left-0" >
                <div className="inset-0 fixed bg-slate-800 w-screen z-50 h-[100vh] bg-opacity-70 flex items-center px-3">
                    <div data-aos="fade" data-aos-duration="600" data-aos-easing="ease-in-out" className="rounded-lg space-y-4 bg-white mx-auto w-[45rem] md:px-14">
                        <div className=' text-slate-700 rounded-xl p-6 relative bg-white h-[50rem]  '>
                            ...
                            <div className='space-y-6 pt-6 h-[40em] fixed overflow-y-scroll w-[23rem] md:w-[35rem] mx-auto justify-center'>
